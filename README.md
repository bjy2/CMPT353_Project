...
##How to use
Run local server:
To run the project, open a terminal and navigate to the root directory of the project using cd. Then, start the application by running python app.py. Once the server starts, you will see a message like “Running on http://127.0.0.1:5000” in the terminal. Copy this URL and paste it into your browser to access the application.
